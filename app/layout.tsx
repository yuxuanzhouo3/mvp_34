...
export const metadata: Metadata = {
  ...
  other: {
    // Avoid browser translation extensions mutating DOM before hydration
    google: "notranslate",
  },
};
...
export default async function RootLayout({
  ...
  return (
    <html lang={DEFAULT_LANGUAGE} suppressHydrationWarning translate="no" className="notranslate">
