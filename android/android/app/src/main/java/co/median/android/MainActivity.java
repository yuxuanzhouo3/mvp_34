...
public class MainActivity extends AppCompatActivity implements Observer,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.googleSignInBridge = new GoogleSignInBridge(this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (googleSignInBridge != null && googleSignInBridge.onActivityResult(requestCode, resultCode, data)) {
            return;
        }
    ...
    public GoogleSignInBridge getGoogleSignInBridge() {
        return googleSignInBridge;
    }
