  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3 mb-4">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-gray-400/20 to-gray-500/20 flex items-center justify-center">
      ...
      <div className="rounded-xl bg-gray-500/10 border border-gray-500/20 p-4">
        <div className="flex items-start gap-3">
          <Apple className="h-5 w-5 text-gray-600 dark:text-gray-400 mt-0.5 flex-shrink-0" />
          <div>
